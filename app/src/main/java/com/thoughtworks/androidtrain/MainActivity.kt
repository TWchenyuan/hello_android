        ...
        repeat(10) {
            ...
            val button =
                Button(this).apply {
                    ...
                    layoutParams =
                        LayoutParams(250.dp, LayoutParams.WRAP_CONTENT).apply {
    ...
    private fun handleClicker(key: String, button: Button) {
        val target =
            when (key) {
                ...
                "tweet_list_compose" -> View.OnClickListener {
                    jumpToActivity(TweetListComposeActivity::class.java)
                }
                else -> null
            }
